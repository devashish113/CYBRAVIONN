...
export const ThreatRadar3D: React.FC = () => {
  ...
  return (
    <section className="relative py-24 md:py-32 px-6 md:px-12 lg:px-20 overflow-hidden bg-gradient-to-b from-[#010309]/80 via-[#010206]/92 to-[#000000] backdrop-blur-[3px]">
